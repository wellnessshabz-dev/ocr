...
- `raw/skills/pptx/scripts/`
- `raw/skills/pptx/LICENSE.txt`
- `raw/skills/pptx/SKILL.md`
- `raw/skills/pptx/editing.md`
- `raw/skills/pptx/pptxgenjs.md`
...
---
*pptx — Skill Template — part of the OCR system. See `_index.md` in this directory for orientation.*
